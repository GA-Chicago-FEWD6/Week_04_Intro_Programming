...
// Do you need to target the specfic box, why does 'body' not work here?
...
$('#reset').on('click', function(){
	$('.box, h1, h2, h3, h4, h5, h6, footer' ).fadeIn('slow').removeClass('crazy fun unique');
});

// 	Hi! I was not sure if this was the correct  way to go about this, were we supposed to clear all the
// changes we made or just remove the added classes?
